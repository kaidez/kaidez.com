...
function kaidez_swiss_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'kaidez-swiss' ),
	) );
...
function kaidez_swiss_scripts() {
	...
	wp_enqueue_script( 'kaidez-swiss-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'kaidez-swiss-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
