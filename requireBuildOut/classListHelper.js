 ...
 * 'grunt-modernizr' doesn't look for non-core detects when it builds * out our Modernizr custom build. We need to manually add it using 
 * the Modernizr addTest() API.
 */
